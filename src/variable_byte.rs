...
impl VariableByte {
    ...
    where
        T: Compressor,
    {
        T::compress(input, input_length, input_offset, output, output_offset)
    }
    ...
    where
        T: Compressor,
    {
        T::uncompress(input, input_length, input_offset, output, output_offset)
    }
}
