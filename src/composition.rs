...
use crate::{Codec, FastPForResult, IntegerCodec};
...
impl Composition {
    fn compress(
        ...
        self.c1
            .compress(input, input_offset, input_length, output, output_offset)?;
    ...
    fn uncompress(
        ...
        self.c1
            .uncompress(input, input_offset, input_length, output, output_offset)?;
